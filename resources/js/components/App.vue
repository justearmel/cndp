                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="card">
                            <div class="card-inner card-inner-lg">
                                ...
                                <div v-if="message !== ''" style="color:white" class="alert alert-fill alert-success alert-icon" role="alert">
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-lg" v-model="login" id="login" placeholder="Entrer votre login">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                    ...
                                    <div class="form-group">
                                        <button class="btn btn-lg btn-secondary btn-block" @click="seconnecter">Se connecter</button>
                                    </div>
                                </form>
