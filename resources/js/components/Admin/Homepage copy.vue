                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            <div class="card-title">
                                                                <h6 class="title"> <em class="icon ni ni-user-alt"></em> Enseignants</h6>
                                                            </div>
                                                        </div>
                                                        <div class="data">
                                                            <div class="data-group">
                                                                <div class="amount">{{nbteachers}}</div>
                                                                <div class="nk-ecwg6-ck"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            <div class="card-title">
                                                                <h6 class="title"><em class="icon ni ni-user-alt"></em> Parents</h6>
                                                            </div>
                                                        </div>
                                                        <div class="data">
                                                            <div class="data-group">
                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            <div class="card-title">
                                                                <h6 class="title"><em class="icon ni ni-building"></em> Classes</h6>
                                                            </div>
                                                        </div>
                                                        <div class="data">
                                                            <div class="data-group">
                                            ...
                                            <div class="card">
                                                <div class="nk-ecwg nk-ecwg6">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            <div class="card-title">
                                                                <h6 class="title"><em class="icon ni ni-comments"></em> Messages</h6>
                                                            </div>
                                                        </div>
                                                        <div class="data">
                                                            <div class="data-group">
...
export default {
    setup()
    {
  const { getstudentsNb,getclassesNb,getteachersNb,nbstudents,nbclasses,nbteachers} = useSessions();
     onMounted(getstudentsNb);
     onMounted(getclassesNb);
     onMounted(getteachersNb);
console.log('nous sommes au niveau de la homepage')

return {
 getstudentsNb,getteachersNb,
nbstudents,
nbclasses,
nbteachers,
getclassesNb
