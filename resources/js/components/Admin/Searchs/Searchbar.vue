<template>
    <div>
                ...
                <div class="alert alert-pro alert-primary">
                    <div class="alert-text">
                        ...
                        <div class="nk-header-search " style="display:block;">
                            ...
                            <input type="text" v-model="libelle" data-value="{{ libelle }}"
                                class="form-control border-transparent form-focus-none"
                                placeholder="Rechercher par son prénom ou son matricule">
                        </div>
        ...
        <div class="nk-tb-list is-separate mb-3" v-if="visibiliy">
            ...
            <div class="nk-tb-item" v-for="item in resultat" :key="item.id" @click="detailstudent(item.id)"
