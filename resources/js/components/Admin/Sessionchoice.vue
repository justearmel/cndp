                        ...
                        <div class="container-fluid">
                                ...
                                <div class="nk-content-body">
                                    <div class="alert alert-pro alert-primary">
                                        <div class="alert-text">
                                            ...
                                            <p>Bienvenue sur l'espace d'administration du Collège Notre Dame de la Paix
                                                d'Abadjin kouté </p>

                                            <div class="example-alert">
                                                <div class="alert alert-fill alert-light alert-icon">
                                                    <em class="icon ni ni-alert-circle"></em> Merci de sélectionner une
                                                    <strong>année scolaire</strong> svp !
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-bordered card-preview">
                                <div class="card-inner">
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4" v-for="item in thesessions"
                                            :key="item.id_sessions">
                                            <div class="card pricing">
                                                <div class="pricing-head">
                                                    <div class="pricing-media" style="">
                                                        <img src="/assets/images/rentrer.jpeg" alt=""
                                                            style="max-width: 100%;">
                                                    </div>
                                                ...
                                                <div class="pricing-body">
                                                    <ul class="pricing-features">
                                                        <li><span class="w-50">Total inscrits</span> - <span
                                                                class="ms-auto">{{ item.nbinscrit_sessions }}</span></li>
                                                        <!-- <li><span class="w-50">Total sortant</span> - <span class="ms-auto">{{item.nbsortant_sessions}}</span></li> -->
                                                        <li><span class="w-50">Total affectés</span> - <span
                                                                class="ms-auto">{{ item.nbaffecte_sessions }}</span></li>
                                                        <li><span class="w-50">Total internes</span> - <span
                                                                class="ms-auto">{{ item.nbinternes_sessions }}</span></li>
                                                    </ul>
                                                    <div class="pricing-action">
                                                        <button class="btn btn-primary"
                                                            @click="choisirsession(item.libelle_sessions)">Sélectionner
                                                            cette année</button>
                                                        <button class="btn btn-primary"
                                                            @click="updatingone(item.libelle_sessions)">Mise à jour
                                                            1</button>
                                                    </div>
                                                </div>
                                            </div>
