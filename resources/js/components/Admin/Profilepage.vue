                                ...
                                <div class="card">
                                    <div class="card-aside-wrap">
                                        <div class="card-inner">
                                            <div class="preview-block" v-if="statevisible == true">
                                                <div class="nk-block-head-content">
                                                    <h4 class="nk-block-title">Informations Personnelles</h4>

                                                    <div v-if="error !== ''"
                                                        class="alert alert-fill alert-danger alert-icon"
                                                ...
                                                <div class="row gy-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" v-model="nom"
                                                                    id="nom" placeholder="Entrer votre nom">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="prenom">Prénoms <span
                                                                    style="color:red">*</span></label>
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" v-model="prenom"
                                                                    id="prenom" placeholder="Entrer votre prénom">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="datenais">Date de naissance
                                                                <span style="color:red">*</span></label>
                                                            <div class="form-control-wrap">
                                                                <input type="date" class="form-control"
                                                                    v-model="datenais" id="datenais"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="lieunais">Lieu de naissance
                                                                <span style="color:red">*</span></label>
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control"
                                                                    v-model="lieunais" id="lieunais"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <select class="form-control" v-model="genre">
                                                                    <option selected value="" data-select2-id="25">
                                                                        Sélectionner un genre</option>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="nationalite">Nationalité
                                                                <span style="color:red">*</span></label>
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control"
                                                                    v-model="nationalite" id="nationalite"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" v-model="email"
                                                                    id="email" placeholder="Entrer votre adresse email">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control"
                                                                    v-model="telephone" id="telephone"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-lg btn-primary"
                                                                @click="personnalBtn"><em class="icon ni ni-edit"></em>
                                                                Modifier</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="preview-block" v-if="statevisible == false">
                                                <div class="nk-block-head-content">
                                                    <h4 class="nk-block-title">Paramètre de connexion</h4>
                                                ...
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <button type="submit" class="btn btn-lg btn-primary"
                                                                @click="parametreBtn"> <em class="icon ni ni-edit"></em>
                                                                Modifier</button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card-aside card-aside-left user-aside toggle-slide toggle-slide-left toggle-break-md toggle-screen-md"
                                            data-toggle-body="true" data-content="userAside" data-toggle-screen="md"
                                            ...
                                            <div class="card-inner-group" data-simplebar="init">
                                                <div class="simplebar-wrapper" style="margin: 0px;">
                                                                ...
                                                                <div class="simplebar-content" style="padding: 0px;">
                                                                    <div class="card-inner">
                                                                        <div class="user-card">
                                                                            ...
                                                                            <div class="user-info">
                                                                                <span class="lead-text">{{ Username
                                                                                }}</span>
                                                                                <span class="sub-text">{{ email
                                                                                }}</span>
                                                                            </div>
                                                                    ...
                                                                    <div class="card-inner p-0">
                                                                        <ul class="link-list-menu" v-if="statevisible">
                                                                            <li><a @click="changeTo(true)"
                                                                                    class="active" href="#"><em
                                                                                        class="icon ni ni-user-fill-c"></em><span>Informations
                                                                                        personnelles</span></a></li>
                                                                            <li><a @click="changeTo(false)" href="#"><em
                                                                                        class="icon ni ni-lock-alt-fill"></em><span>Paramètre
                                                                                        de connexion</span></a></li>
                                                                        </ul>
                                                                        <ul class="link-list-menu"
                                                                            v-if="statevisible == false">
                                                                            <li><a @click="changeTo(true)" href="#"><em
                                                                                        class="icon ni ni-user-fill-c"></em><span>Informations
                                                                                        personnelles</span></a></li>
                                                                            <li><a class="active"
                                                                                    @click="changeTo(false)"
                                                                                    href="#"><em
                                                                                        class="icon ni ni-lock-alt-fill"></em><span>Paramètre
                                                                                        de connexion</span></a></li>
                                                                        </ul>
                                                    ...
                                                    <div class="simplebar-placeholder"
                                                        style="width: auto; height: 403px;"></div>
                                                </div>
