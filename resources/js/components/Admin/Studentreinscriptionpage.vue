                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap">
                                                                    ...
                                                                    <ul class="custom-control-group" v-if="genre=='F'">
                                                                         <li>
                                                                    ...
                                                                    <ul class="custom-control-group" v-if="genre=='M'">
                                                                         <li>
                                                                            <div class="custom-control custom-radio custom-control-pro no-control ">
                                                                                <input type="radio" class="custom-control-input invalid" name="genre" @click="changesexe('F')"   id="sex-female" required="">
                                                                                <label class="custom-control-label" for="sex-female">Fille</label>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="custom-control custom-radio custom-control-pro no-control">
                                                                                <input type="radio" class="custom-control-input invalid" name="genre" id="sex-male" checked="checked" @click="changesexe('M')" aria-describedby="fv-sex-error">
                                                                                <label class="custom-control-label" for="sex-male">Garçon</label>
                                                                            </div>
                                                                        </li>
 ...
 mounted() {
    ...
    methods: {
        getstudentinfos()
        {
           ...
           let lasession = localStorage.getItem("UserSessionchoose");

axios.get('/sanctum/csrf-cookie').then(response => {
                     axios.get('/api/getstudentinfos/'+studentid)
                        .then(response => {
                               let student=response.data.data;
                               this.nom=student[0].nom_users;
                               this.prenom=student[0].prenom_users;
                               this.datenais=student[0].datenais_users;
                               this.lieunais=student[0].lieunais_users;
                               this.lieuhabitation=student[0].lieuh_users;
                               this.nationalite=student[0].nationalite_users;
                               this.genre=student[0].sexe_users;
                               this.lastschool=localStorage.getItem("schoolName");
                               this.matricule=student[0].matricule_users;
                               this.affecte=student[0].affecter_users;
                               this.interne=student[0].interne_users;
                               this.pere=student[0].pere_users;
                               this.mere=student[0].mere_users;
                               this.professionpere=student[0].professionpere_users;
                               this.contactpere=student[0].contactpere_users;
                               this.professionmere=student[0].professionmere_users;
                               this.contactmere=student[0].contactmere_users;
                               this.principal=student[0].principal_users;
                               this.phoneprincipal=student[0].contactprincipal_users;
